"""
Builds the v2 zarr from the downloaded parquets.
...
Prints three checks first. If the TSO shares barely move the data is not
really regional, and nothing gets written.
...
# approximate control-area centroids
LATLON = {
    "50Hertz": (52.5, 13.5),
    "Amprion": (51.5, 7.5),
    "TenneT": (51.0, 10.5),
