"""
Builds v4 from v3. Adds a national row and shifts the TSOs up.

location_id 0 is the national total, 1-4 are the four TSOs. This is what
ocf-data-sampler expects, it drops id 0 from the inputs and uses it as the
summation target.

The national capacity is the four TSO capacities added up, not recalculated
on the national series, so it reads a bit high.
...
NATIONAL_LATLON = (51.0, 10.0)  # central Germany
